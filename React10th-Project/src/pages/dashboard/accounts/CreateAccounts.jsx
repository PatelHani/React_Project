...
function CreateAccounts() {
  ...
  const handleSubmit = async e => {
    ...
    if (state.branchCode > 99) {
      toast.error('You can use only 999 branches.', {
        position: "bottom-left",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    if (state.initialDeposit < 500) {
      toast.error('Your initial Deposit is less than 1000 PKR. .', {
        position: "bottom-left",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="row ">
                  ...
                  <div class="form-floating mb-3">
                    ...
                    <label for="floatingInput">Account Number(Length should be 9)</label>  </div>
              </div>
              <div className="row ">
                  <div class="form-floating mb-3">

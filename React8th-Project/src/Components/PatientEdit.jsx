...
navigate('/add');    
  ...
  return (
    ...
    <button className="two-btn" onClick={handleAdd} element={<PatientAdd />}><span className="text-underline">Add Patient</span></button>
  </div> 
      <h3 style={{fontFamily:"Kanit, sans-serif"}}>Patients Data</h3>
      <div className='list'>
